...
def getEventLogs(server, logtype, logPath):
    ...
    print("Total events in "+logtype +"=" + str(total))
    ...
    print("Log creation finished. Location of log is"+logPath)
 
 
if __name__ == "__main__":
    server = None  # None = local machine
    logTypes = ["System", "Application", "Security"]
    getAllEvents(server, logTypes, "C:\Windows\System32\winevt\Logs")